...
class InfoDialog extends Component<Props, State> {
        ...
        const inlineDialog = (
            <div
                ...
                <div className = 'info-dialog-column'>
                    ...
                    <div className = 'info-dialog-dial-in' style={{display:'none'}}>
                        { this._renderDialInDisplay() }
                    </div> 
                    { liveStreamViewURL && this._renderLiveStreamURL() }
                    <div className = 'info-dialog-password' style={{display:'none'}}>
                        <PasswordForm
                    ...
                    <div className = 'info-dialog-action-links' style={{display:'none'}}>
     ...
     */
    _getTextToCopy() {
        const { _localParticipantName, liveStreamViewURL, t, _roomName } = this.props;
        const livestreamURL = interfaceConfig.LIVESTREAM_URL+_roomName.replace(/-/gi,'');
    ...
    _renderLiveStreamURL() {
        const { liveStreamViewURL, t , _roomName} = this.props;
        const livestreamURL =interfaceConfig.LIVESTREAM_URL+_roomName.replace(/-/gi,'');
            ...
            <div className = 'info-dialog-live-stream-url'>
                ...
                <span className = 'info-value'>
                    <a
                        ...
                        href = { livestreamURL }
                        onClick = { this._onClickURLText } >
                        { livestreamURL.replace('https://','') }
                    </a>
                </span>
                 <span className = 'info-dialog-url-icon'>
                            <Icon
                                onClick = { this.copyToClipboard(livestreamURL) }
                                size = { 18 }
                                src = { IconCopy } />
                        </span>
            </div>
