...
import { CHAT_ENABLED, getFeatureFlag, INVITE_ENABLED } from '../../../base/flags';
...
class Toolbox extends PureComponent<Props> {
     ...
     */
    _renderToolbar() {
        const { _chatEnabled, _styles, _inviteEnabled, _audioOnly } = this.props;
        ...
        return (
            ...
            <View
                ...
                {!_audioOnly && <ToggleCameraButton styles = { buttonStyles }
