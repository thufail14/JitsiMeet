...
import { Platform, Container, LoadingIndicator, TintedView } from '../../../base/react';
...
import { AddPeopleDialog, CalleeInfoContainer, isOutGoingCall, CalleeInfoNew, isStillRinging } from '../../../invite';
...
class Conference extends AbstractConference<Props, *> {
    ...
    _renderContent() {
        ...
        const isOutGoingCallRinging = isOutGoingCall(_callInfo.callType) && isStillRinging(_callInfo.callStatus);
        ...
        return (
            <>
                ...
                <SafeAreaView
                    ...
                    {/* <Labels /> */}
                    {isOutGoingCallRinging && <CalleeInfoNew callInfo={_callInfo} />}
                    {!isOutGoingCallRinging && !_shouldDisplayTileView && _toolboxVisible &&
                        <CalleeInfoNew name={_largeVideoParticipantName} />
                    }
...
function _mapStateToProps(state) {
    ...
    const largeVideoParticipantName = getParticipantDisplayName(state, largeVideoParticipantId);
    ...
    return {
        ...
        _callInfo: state['features/callinfo'],
