...
class BottomSheet extends PureComponent<Props> {
     ...
     */
    render() {
        const { _styles, renderHeader, slidingPosition } = this.props;
        const position = slidingPosition || 'bottom';
        const sheetContainer = position === 'top' ? {} : styles.sheetContainer;
        ...
        return (
            <SlidingView
                ...
                <View
                    ...
                    { position != 'top' && renderHeader && renderHeader() }
                    <SafeAreaView
                        style = { [
