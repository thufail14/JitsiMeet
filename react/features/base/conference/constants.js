...
/**
 * The command type for updating a participant's app jid.
 *
 * @type {string}
 */
export const APP_JID_COMMAND = 'app_jid';
...
/**
 * Default call mode type
 */
export const DEFAULT_CALL_MODE = 'onetomany';
/**
 * Call mode type constants
 */
export const CALL_MODE_CONFERENCE = 'onetomany';
export const CALL_MODE_MEETING = 'manytomany';
export const CALL_MODE_ONETOONE = 'onetoone';