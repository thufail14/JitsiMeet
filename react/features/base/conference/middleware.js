...
function _conferenceJoined({ dispatch, getState }, next, action) {
    ...
    const { displayName } = getState()['features/base/settings'];
    ...
    let profileobj = JSON.parse(localStorage.getItem('profileobj'))
    let name = displayName !== '' ? displayName : (profileobj !== '' ? profileobj.name : '')
    if(name){
