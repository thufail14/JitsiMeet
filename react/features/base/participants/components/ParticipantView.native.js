...
const appBackgroundImage = require('../../../../../images/appBackground.png');
...
class ParticipantView extends Component<Props> {
    ...
    renderView(){
        ...
        const avatarContainerCustomStyle = !isThumbnailView && !_reducedUI ? {position:'relative',top:-50} : {}
        const imageBackgroundSrc = !isThumbnailView ? appBackgroundImage : '';
        ...
        return (
            <>
                ...
                { !renderVideo
                    && <View style = {{...styles.avatarContainer, ...avatarContainerCustomStyle}}>
                        <Avatar
    ...
    render() {
        ...
        return (
            <Container
                ...
                touchFeedback = { false }>
                    {!isThumbnailView && <ImageBackground source={appBackgroundImage} style={styles.imageBackground}>  
                        {this.renderView()}
                    </ImageBackground>}
                    {isThumbnailView && this.renderView()}
            </Container>
        );
    }
}
