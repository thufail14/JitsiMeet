...
import CalleeInfoContainerStatic from "../../../invite/components/callee-info-no-redux/CalleeInfoContainerStatic";
...
export default class BaseApp extends Component<*, State> {
    ...
    render() {
        ...
        return this._displayElementBeforeStore();
    }
    ...
    _createMainElement(component, props) {
        return component ? React.createElement(component, props || {}) : this._displayElementBeforeStore();
    }
    ...
    _displayElementBeforeStore(){
        return this.props.callInfo && this.props.callInfo.callType === CALL_TYPE_OUTGOING ? this._createMainElement(CalleeInfoContainerStatic, this.props) : null;
    }
}
