            ...
            if (participant
                && !participant.local) {
                    ...
                    let notificationProps = {
                        descriptionArguments:{name:participant.name || '$t(notify.somebody)'},
                        descriptionKey: '{{name}} $t(notify.disconnected)',
                        titleKey: 'notify.somebody',
                ...
                store.dispatch(showNotification(notificationProps, NOTIFICATION_TIMEOUT));
            }
        }
