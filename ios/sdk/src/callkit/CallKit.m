...
static NSString * const RNCallKitPerformSetHoldedCallAction
    = @"performSetHoldedCallAction";
...
- (NSArray<NSString *> *)supportedEvents {
    return @[
        ...
        RNCallKitPerformSetHoldedCallAction,
...
// Handle audio hold from CallKit view
- (void) performSetHoldedCallWithUUID:(NSUUID *)UUID
                             isHolded:(BOOL)isHolded {
    DDLogInfo(@"[RNCallKit][CXProviderDelegate][provider:performSetHoldedCallAction:]");
    
    [self sendEventWithName:RNCallKitPerformSetHoldedCallAction
                       body:@{
                              @"callUUID": UUID.UUIDString,
                              @"muted": @(isHolded)
                              }];
