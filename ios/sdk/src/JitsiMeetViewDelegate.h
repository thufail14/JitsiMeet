...
/**
 * Called before a conference will leave.
 *
 * The `data` dictionary contains a `url` key with the conference URL.
 */
...
/**
 * Call when end user left the confenrece.
 *
 * The `data` dictionary contains a `url` key with the conference URL.
 */
...
/**
 * Call when end user joins the confenrece.
 *
 * The `data` dictionary contains a `url` key with the conference URL.
 */
- (void)joinedParticipantAppJid:(NSDictionary *)data;
