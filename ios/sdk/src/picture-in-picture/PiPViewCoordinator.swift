...
@objc public class PiPViewCoordinator : NSObject {
    ...
    @objc public func configureAsStickyView(withParentView parentView: UIView? = nil) {
        guard
    ...
    @objc public func show(completion: AnimationCompletion? = nil) {
    ...
    @objc public func hide(completion: AnimationCompletion? = nil) {
    ...
    /// screen size changes
    @objc public func resetBounds(bounds: CGRect) {
        currentBounds = bounds
        exitPictureInPicture()
    }

    /// Stop the dragging gesture of the root view
    @objc public func stopDragGesture() {
        dragController.stopDragListener()
    }
