...
#pragma mark - CallKit Utility methods

- (void)callEventsWithEventName:(NSString *)eventName body:(NSDictionary*)body {
    [_bridgeWrapper.bridge enqueueJSCall:@"RCTDeviceEventEmitter"
                    method:@"emit"
