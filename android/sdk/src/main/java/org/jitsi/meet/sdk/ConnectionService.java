...
public class ConnectionService extends android.telecom.ConnectionService {
    ...
    public static void holdCurrentCall(boolean isMuteCall) {
        WritableNativeMap data = new WritableNativeMap();
        data.putBoolean("muted", isMuteCall);
        Log.d(TAG, "holdCurrentCall: "+isMuteCall);
        ReactInstanceManagerHolder.emitEvent("org.jitsi.meet:features/connection_service#onhold", data);
    }
    @Override
