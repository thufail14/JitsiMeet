...
public class JitsiMeetConferenceOptions implements Parcelable {
    ...
    public static class Builder {
        ...
        public JitsiMeetConferenceOptions build() {
            ...
            options.callInfo=this.callInfo;
            return options;
        }
    }
    ...
    private JitsiMeetConferenceOptions(Parcel in) {
        ...
        callInfo=  in.readParcelable(CallInfo.class.getClassLoader());
    ...
    Bundle asProps() {
        ...
        if (featureFlags.containsKey("callmode")) {
             CallModeUtils.setCallMode(Objects.requireNonNull(featureFlags.getString("callmode")));
        }
        ...
        if(callInfo !=null){
            props.putBundle("callInfo", ConstructBundle.INSTANCE.getCallUsersJsonObject(callInfo));
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(callInfo,flags);
