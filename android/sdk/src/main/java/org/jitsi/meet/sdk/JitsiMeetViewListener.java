...
public interface JitsiMeetViewListener {
    ...
    /**
     * Called before when the user left the  conference.
     *
     * @param data Map with a "url" key with the conference URL.
     */
    ...
    /**
     * Called when the remote user joined the  conference.
     *
     * @param data Map with a "url" key with the conference URL.
     */
    ...
    /**
     *Called when the remote user left the  conference.
     *
     */
    ...
    /**
     * called when the remote user joined the call
     * @param data
     */
    void  onJoinedParticipantAppJid(Map<String, Object> data);
}
