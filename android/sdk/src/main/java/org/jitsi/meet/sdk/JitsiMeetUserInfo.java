...
public class JitsiMeetUserInfo {
    ...
    public void setCallInitiator(boolean callInitiator) {
    ...
    public JitsiMeetUserInfo(Bundle b) {
        ...
        if (b.containsKey("appJid")) {
            appJid = b.getString("appJid");
        }

        if(b.containsKey("callInitiator"))
        {
            callInitiator=b.getBoolean("callInitiator");
        }
    }
    ...
    Bundle asBundle() {
        ...
        if (appJid != null) {
            b.putString("appJid", appJid);
        }

        if (callInitiator) {
            b.putBoolean("callInitiator", true);
        }
        return b;
    }
}
